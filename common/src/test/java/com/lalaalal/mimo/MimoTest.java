...
public class MimoTest {
    ...
    public static final Content MODRINTH_TEST_CONTENT = new Content(ProjectType.MOD, List.of(Loader.Type.FABRIC), ContentProviders.MODRINTH, CONTENT_ID, CONTENT_SLUG);
